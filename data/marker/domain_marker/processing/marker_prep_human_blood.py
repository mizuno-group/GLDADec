...
pd.to_pickle(domain_dic,'/workspace/github/GLDADec/data/marker/domain_marker/results/gse65133_domain_dic.pkl')
...
pd.to_pickle(domain_dic,'/workspace/github/GLDADec/data/marker/domain_marker/results/gse107572_domain_dic.pkl')
...
pd.to_pickle(domain_dic,'/workspace/github/GLDADec/data/marker/domain_marker/results/gse60424_domain_dic.pkl')