...
pre_domain_dic = pd.read_pickle('/workspace/github/GLDADec/data/marker/domain_marker/results/gse107572_domain_dic.pkl') # defined above section
...
k = ['Monocytes','NK cells','B cells naive','B cells memory','T cells CD4 naive','T cells CD4 memory','T cells CD8','T cells gamma delta','Neutrophils','Dendritic cells','Treg']
v = [mon_marker,nk_marker,bn_marker,bm_marker,cd4n_marker,cd4m_marker,cd8_marker,gd_marker,neu_marker,dc_marker,treg_marker]
domain_dic = dict(zip(k,v))

pd.to_pickle(domain_dic,'/workspace/github/GLDADec/data/marker/domain_marker/results/v3/domain_dic.pkl')
