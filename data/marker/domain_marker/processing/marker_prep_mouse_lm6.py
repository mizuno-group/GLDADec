...
pd.to_pickle(deg_dic,'/workspace/github/GLDADec/data/expression/rat/marker/MouseLM6_DEGs/lm6_10_APAP.pkl')
# %%
# up to 20
rat_df = pd.read_csv('/workspace/github/GLDADec/data/expression/rat/Morita_rat/vs_APAP/rat_dili_APAP_expression.csv',index_col=0)
ref_df = pd.read_csv('/workspace/github/LiverDeconv/Data/processed/ref_13types.csv',index_col=0)
...
pd.to_pickle(deg_dic,'/workspace/github/GLDADec/data/expression/rat/marker/MouseLM6_DEGs/lm6_20_APAP.pkl')
# %%
"""
Mouse LM13 derived DEGs for rat analysis (MDA)
"""
# up to 10
rat_df = pd.read_csv('/workspace/github/GLDADec/data/expression/rat/Morita_rat/vs_MDA/rat_dili_MDA_expression.csv',index_col=0)
ref_df = pd.read_csv('/workspace/github/LiverDeconv/Data/processed/ref_13types.csv',index_col=0)
...
pd.to_pickle(deg_dic,'/workspace/github/GLDADec/data/expression/rat/marker/MouseLM6_DEGs/lm6_10_MDA.pkl')
...
pd.to_pickle(deg_dic,'/workspace/github/GLDADec/data/expression/rat/marker/MouseLM6_DEGs/lm6_20_MDA.pkl')