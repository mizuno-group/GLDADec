...
pd.to_pickle(deg_dic,'/workspace/github/GLDADec/data/expression/rat/marker/MouseLM13_DEGs/lm13_10_MDA.pkl')
...
pd.to_pickle(deg_dic,'/workspace/github/GLDADec/data/expression/rat/marker/MouseLM13_DEGs/lm13_20_MDA.pkl')
...
pd.to_pickle(deg_dic,'/workspace/github/GLDADec/data/expression/rat/marker/MouseLM13_DEGs/lm13_50_MDA.pkl')
# %%
