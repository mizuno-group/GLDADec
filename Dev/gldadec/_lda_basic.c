...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "include_dirs": [
            ".",
            "/home/docker/miniconda3/envs/deconv/lib/python3.9/site-packages/numpy/core/include"
        ],
        "name": "_lda_basic",
        "sources": [
            "_lda_basic.pyx",
...
#define __PYX_HAVE___lda_basic
#define __PYX_HAVE_API___lda_basic
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include "gamma.h"
...
/* Module declarations from '_lda_basic' */
...
static double __pyx_f_10_lda_basic_lgamma(double); /*proto*/
static int __pyx_f_10_lda_basic_searchsorted(double *, int, double); /*proto*/
static int __pyx_f_10_lda_basic_judge_z(int, __Pyx_memviewslice); /*proto*/
static double __pyx_f_10_lda_basic__loglikelihood(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double, double, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "_lda_basic"
extern int __pyx_module_is_main__lda_basic;
int __pyx_module_is_main__lda_basic = 0;

/* Implementation of '_lda_basic' */
...
static const char __pyx_k_lda_basic[] = "_lda_basic";
static const char __pyx_k_pyx_state[] = "__pyx_state";
static const char __pyx_k_reduce_ex[] = "__reduce_ex__";
static const char __pyx_k_seed_conf[] = "seed_conf";
static const char __pyx_k_seed_keys[] = "seed_keys";
static const char __pyx_k_IndexError[] = "IndexError";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_other_conf[] = "other_conf";
...
static const char __pyx_k_lda_basic_pyx[] = "_lda_basic.pyx";
...
static PyObject *__pyx_n_s_lda_basic;
static PyObject *__pyx_kp_s_lda_basic_pyx;
...
static PyObject *__pyx_n_s_other_conf;
...
static PyObject *__pyx_n_s_seed_conf;
static PyObject *__pyx_n_s_seed_keys;
...
static PyObject *__pyx_pf_10_lda_basic__sample_topics(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_WS, __Pyx_memviewslice __pyx_v_DS, __Pyx_memviewslice __pyx_v_ZS, __Pyx_memviewslice __pyx_v_nzw, __Pyx_memviewslice __pyx_v_ndz, __Pyx_memviewslice __pyx_v_nz, __Pyx_memviewslice __pyx_v_alpha, __Pyx_memviewslice __pyx_v_eta, __Pyx_memviewslice __pyx_v_rands, __Pyx_memviewslice __pyx_v_seed_keys, double __pyx_v_seed_conf, double __pyx_v_other_conf); /* proto */
static PyObject *__pyx_pf_10_lda_basic_2_loglikelihood(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_nzw, __Pyx_memviewslice __pyx_v_ndz, __Pyx_memviewslice __pyx_v_nz, __Pyx_memviewslice __pyx_v_nd, double __pyx_v_alpha, double __pyx_v_eta); /* proto */
...
static double __pyx_f_10_lda_basic_lgamma(double __pyx_v_x) {
  double __pyx_r;
 ...
 */
  ...
  __Pyx_WriteUnraisable("_lda_basic.lgamma", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  #ifdef WITH_THREAD
  __Pyx_PyGILState_Release(__pyx_gilstate_save);
...
static int __pyx_f_10_lda_basic_searchsorted(double *__pyx_v_arr, int __pyx_v_length, double __pyx_v_value) {
  int __pyx_v_imin;
  int __pyx_v_imax;
  int __pyx_v_imid;
  int __pyx_r;
...
static int __pyx_f_10_lda_basic_judge_z(int __pyx_v_w, __Pyx_memviewslice __pyx_v_seed_keys) {
  int __pyx_v_c;
  int __pyx_v_i;
  int __pyx_r;
  size_t __pyx_t_1;
 ...
 *             c = 1
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_seed_keys); 
  __pyx_t_2 = __pyx_t_1;
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_t_5 = ((__pyx_v_w == (*((long *) ( /* dim=0 */ (__pyx_v_seed_keys.data + __pyx_t_4 * __pyx_v_seed_keys.strides[0]) )))) != 0);
    if (__pyx_t_5) {
...
/* Python wrapper */
static PyObject *__pyx_pw_10_lda_basic_1_sample_topics(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_10_lda_basic_1_sample_topics = {"_sample_topics", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_10_lda_basic_1_sample_topics, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_10_lda_basic_1_sample_topics(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_memviewslice __pyx_v_seed_keys = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_seed_conf;
  double __pyx_v_other_conf;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_WS,&__pyx_n_s_DS,&__pyx_n_s_ZS,&__pyx_n_s_nzw,&__pyx_n_s_ndz,&__pyx_n_s_nz,&__pyx_n_s_alpha,&__pyx_n_s_eta,&__pyx_n_s_rands,&__pyx_n_s_seed_keys,&__pyx_n_s_seed_conf,&__pyx_n_s_other_conf,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_DS)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 12, 12, 1); __PYX_ERR(0, 50, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ZS)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 12, 12, 2); __PYX_ERR(0, 50, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nzw)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 12, 12, 3); __PYX_ERR(0, 50, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ndz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 12, 12, 4); __PYX_ERR(0, 50, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 12, 12, 5); __PYX_ERR(0, 50, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_alpha)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 12, 12, 6); __PYX_ERR(0, 50, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_eta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 12, 12, 7); __PYX_ERR(0, 50, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rands)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 12, 12, 8); __PYX_ERR(0, 50, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_seed_keys)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 12, 12, 9); __PYX_ERR(0, 50, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_seed_conf)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 12, 12, 10); __PYX_ERR(0, 50, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_other_conf)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 12, 12, 11); __PYX_ERR(0, 50, __pyx_L3_error)
        }
      }
    ...
    __pyx_v_WS = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_WS.memview)) __PYX_ERR(0, 50, __pyx_L3_error)
    __pyx_v_DS = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_DS.memview)) __PYX_ERR(0, 50, __pyx_L3_error)
    __pyx_v_ZS = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ZS.memview)) __PYX_ERR(0, 50, __pyx_L3_error)
    __pyx_v_nzw = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nzw.memview)) __PYX_ERR(0, 50, __pyx_L3_error)
    __pyx_v_ndz = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ndz.memview)) __PYX_ERR(0, 50, __pyx_L3_error)
    __pyx_v_nz = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nz.memview)) __PYX_ERR(0, 50, __pyx_L3_error)
    __pyx_v_alpha = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_alpha.memview)) __PYX_ERR(0, 51, __pyx_L3_error)
    __pyx_v_eta = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_eta.memview)) __PYX_ERR(0, 51, __pyx_L3_error)
    __pyx_v_rands = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[8], PyBUF_WRITABLE); if (unlikely(!__pyx_v_rands.memview)) __PYX_ERR(0, 51, __pyx_L3_error)
    __pyx_v_seed_keys = __Pyx_PyObject_to_MemoryviewSlice_ds_long(values[9], PyBUF_WRITABLE); if (unlikely(!__pyx_v_seed_keys.memview)) __PYX_ERR(0, 51, __pyx_L3_error)
    __pyx_v_seed_conf = __pyx_PyFloat_AsDouble(values[10]); if (unlikely((__pyx_v_seed_conf == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 51, __pyx_L3_error)
    __pyx_v_other_conf = __pyx_PyFloat_AsDouble(values[11]); if (unlikely((__pyx_v_other_conf == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 51, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_sample_topics", 1, 12, 12, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 50, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("_lda_basic._sample_topics", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10_lda_basic__sample_topics(__pyx_self, __pyx_v_WS, __pyx_v_DS, __pyx_v_ZS, __pyx_v_nzw, __pyx_v_ndz, __pyx_v_nz, __pyx_v_alpha, __pyx_v_eta, __pyx_v_rands, __pyx_v_seed_keys, __pyx_v_seed_conf, __pyx_v_other_conf);
...
static PyObject *__pyx_pf_10_lda_basic__sample_topics(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_WS, __Pyx_memviewslice __pyx_v_DS, __Pyx_memviewslice __pyx_v_ZS, __Pyx_memviewslice __pyx_v_nzw, __Pyx_memviewslice __pyx_v_ndz, __Pyx_memviewslice __pyx_v_nz, __Pyx_memviewslice __pyx_v_alpha, __Pyx_memviewslice __pyx_v_eta, __Pyx_memviewslice __pyx_v_rands, __Pyx_memviewslice __pyx_v_seed_keys, double __pyx_v_seed_conf, double __pyx_v_other_conf) {
  int __pyx_v_i;
  int __pyx_v_k;
  int __pyx_v_w;
  int __pyx_v_d;
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_MemoryError, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 60, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_Raise(__pyx_t_2, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *             if c != 0:
 */
          __pyx_v_c = __pyx_f_10_lda_basic_judge_z(__pyx_v_w, __pyx_v_seed_keys);
 ...
 */
            ...
            __pyx_t_1 = (((*((double *) ( /* dim=0 */ (__pyx_v_rands.data + __pyx_t_17 * __pyx_v_rands.strides[0]) ))) < __pyx_v_seed_conf) != 0);
            if (__pyx_t_1) {
 ...
 */
            /*else*/ {
              __pyx_v_z_new = __pyx_f_10_lda_basic_searchsorted(__pyx_v_dist_sum, __pyx_v_n_topics, __pyx_v_r);
            }
            __pyx_L14:;
 ...
 */
          /*else*/ {
            __pyx_t_17 = __pyx_v_i;
            __pyx_t_1 = (((*((double *) ( /* dim=0 */ (__pyx_v_rands.data + __pyx_t_17 * __pyx_v_rands.strides[0]) ))) < __pyx_v_other_conf) != 0);
            if (__pyx_t_1) {
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_seed_keys, 1);
...
static PyObject *__pyx_pw_10_lda_basic_3_loglikelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_10_lda_basic__loglikelihood(__Pyx_memviewslice __pyx_v_nzw, __Pyx_memviewslice __pyx_v_ndz, __Pyx_memviewslice __pyx_v_nz, __Pyx_memviewslice __pyx_v_nd, double __pyx_v_alpha, double __pyx_v_eta, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_k;
  int __pyx_v_d;
  int __pyx_v_D;
  int __pyx_v_n_topics;
 ...
 * 
 */
        __pyx_v_lgamma_eta = __pyx_f_10_lda_basic_lgamma(__pyx_v_eta);
 ...
 */
        __pyx_v_lgamma_alpha = __pyx_f_10_lda_basic_lgamma(__pyx_v_alpha);
 ...
 */
        __pyx_v_ll = (__pyx_v_ll + (__pyx_v_n_topics * __pyx_f_10_lda_basic_lgamma((__pyx_v_eta * __pyx_v_vocab_size))));
 ...
 */
          __pyx_t_4 = __pyx_v_k;
          __pyx_v_ll = (__pyx_v_ll - __pyx_f_10_lda_basic_lgamma(((__pyx_v_eta * __pyx_v_vocab_size) + (*((int *) ( /* dim=0 */ (__pyx_v_nz.data + __pyx_t_4 * __pyx_v_nz.strides[0]) ))))));
 ...
 */
              __pyx_t_8 = __pyx_v_k;
              __pyx_t_4 = __pyx_v_w;
              __pyx_v_ll = (__pyx_v_ll + (__pyx_f_10_lda_basic_lgamma((__pyx_v_eta + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nzw.data + __pyx_t_8 * __pyx_v_nzw.strides[0]) ) + __pyx_t_4 * __pyx_v_nzw.strides[1]) ))))) - __pyx_v_lgamma_eta));
 ...
 *             for k in range(n_topics):
 */
          __pyx_v_ll = (__pyx_v_ll + (__pyx_f_10_lda_basic_lgamma((__pyx_v_alpha * __pyx_v_n_topics)) - __pyx_f_10_lda_basic_lgamma(((__pyx_v_alpha * __pyx_v_n_topics) + (*((int *) ( /* dim=0 */ (__pyx_v_nd.data + __pyx_t_4 * __pyx_v_nd.strides[0]) )))))));
 ...
 */
              __pyx_t_8 = __pyx_v_d;
              __pyx_t_4 = __pyx_v_k;
              __pyx_v_ll = (__pyx_v_ll + (__pyx_f_10_lda_basic_lgamma((__pyx_v_alpha + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ndz.data + __pyx_t_8 * __pyx_v_ndz.strides[0]) ) + __pyx_t_4 * __pyx_v_ndz.strides[1]) ))))) - __pyx_v_lgamma_alpha));
...
/* Python wrapper */
static PyObject *__pyx_pw_10_lda_basic_3_loglikelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_10_lda_basic_3_loglikelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_nzw = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_ndz = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_nz = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_RefNannySetupContext("_loglikelihood (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ndz)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 6, 6, 1); __PYX_ERR(0, 109, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 6, 6, 2); __PYX_ERR(0, 109, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nd)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 6, 6, 3); __PYX_ERR(0, 109, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_alpha)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 6, 6, 4); __PYX_ERR(0, 109, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_eta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 6, 6, 5); __PYX_ERR(0, 109, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_loglikelihood") < 0)) __PYX_ERR(0, 109, __pyx_L3_error)
      }
    ...
    __pyx_v_nzw = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nzw.memview)) __PYX_ERR(0, 109, __pyx_L3_error)
    __pyx_v_ndz = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ndz.memview)) __PYX_ERR(0, 109, __pyx_L3_error)
    __pyx_v_nz = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nz.memview)) __PYX_ERR(0, 109, __pyx_L3_error)
    __pyx_v_nd = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nd.memview)) __PYX_ERR(0, 109, __pyx_L3_error)
    __pyx_v_alpha = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_alpha == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 109, __pyx_L3_error)
    __pyx_v_eta = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_eta == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 109, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 109, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("_lda_basic._loglikelihood", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10_lda_basic_2_loglikelihood(__pyx_self, __pyx_v_nzw, __pyx_v_ndz, __pyx_v_nz, __pyx_v_nd, __pyx_v_alpha, __pyx_v_eta);
...
static PyObject *__pyx_pf_10_lda_basic_2_loglikelihood(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_nzw, __Pyx_memviewslice __pyx_v_ndz, __Pyx_memviewslice __pyx_v_nz, __Pyx_memviewslice __pyx_v_nd, double __pyx_v_alpha, double __pyx_v_eta) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  if (unlikely(!__pyx_v_nzw.memview)) { __Pyx_RaiseUnboundLocalError("nzw"); __PYX_ERR(0, 109, __pyx_L1_error) }
  if (unlikely(!__pyx_v_ndz.memview)) { __Pyx_RaiseUnboundLocalError("ndz"); __PYX_ERR(0, 109, __pyx_L1_error) }
  if (unlikely(!__pyx_v_nz.memview)) { __Pyx_RaiseUnboundLocalError("nz"); __PYX_ERR(0, 109, __pyx_L1_error) }
  if (unlikely(!__pyx_v_nd.memview)) { __Pyx_RaiseUnboundLocalError("nd"); __PYX_ERR(0, 109, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_10_lda_basic__loglikelihood(__pyx_v_nzw, __pyx_v_ndz, __pyx_v_nz, __pyx_v_nd, __pyx_v_alpha, __pyx_v_eta, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 109, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "_lda_basic._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"_loglikelihood", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_10_lda_basic_3_loglikelihood, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__lda_basic(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__lda_basic},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_lda_basic, __pyx_k_lda_basic, sizeof(__pyx_k_lda_basic), 0, 0, 1, 1},
  {&__pyx_kp_s_lda_basic_pyx, __pyx_k_lda_basic_pyx, sizeof(__pyx_k_lda_basic_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_other_conf, __pyx_k_other_conf, sizeof(__pyx_k_other_conf), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_seed_conf, __pyx_k_seed_conf, sizeof(__pyx_k_seed_conf), 0, 0, 1, 1},
  {&__pyx_n_s_seed_keys, __pyx_k_seed_keys, sizeof(__pyx_k_seed_keys), 0, 0, 1, 1},
 ...
 *         for i in range(eta.shape[0]):
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_u_Could_not_allocate_memory_during); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 60, __pyx_L1_error)
 ...
 *     cdef int i, k, w, d, z, z_new
 */
  __pyx_tuple__22 = PyTuple_Pack(26, __pyx_n_s_WS, __pyx_n_s_DS, __pyx_n_s_ZS, __pyx_n_s_nzw, __pyx_n_s_ndz, __pyx_n_s_nz, __pyx_n_s_alpha, __pyx_n_s_eta, __pyx_n_s_rands, __pyx_n_s_seed_keys, __pyx_n_s_seed_conf, __pyx_n_s_other_conf, __pyx_n_s_i, __pyx_n_s_k, __pyx_n_s_w, __pyx_n_s_d, __pyx_n_s_z, __pyx_n_s_z_new, __pyx_n_s_r, __pyx_n_s_dist_cum, __pyx_n_s_N, __pyx_n_s_n_rand, __pyx_n_s_n_topics, __pyx_n_s_eta_sum, __pyx_n_s_dist_sum, __pyx_n_s_c); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(12, 0, 26, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_lda_basic_pyx, __pyx_n_s_sample_topics, 50, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 50, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_lda_basic(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_lda_basic(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__lda_basic(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__lda_basic(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__lda_basic(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_lda_basic' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__lda_basic(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_lda_basic", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main__lda_basic) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "_lda_basic")) {
      if (unlikely(PyDict_SetItemString(modules, "_lda_basic", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef int i, k, w, d, z, z_new
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10_lda_basic_1_sample_topics, NULL, __pyx_n_s_lda_basic); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_sample_topics, __pyx_t_1) < 0) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init _lda_basic", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init _lda_basic");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
